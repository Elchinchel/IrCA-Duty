...
Реализация обработчика сигналов [Iris Callback API 2.0](https://vk.com/@iris_callback-api2).

## Содержание
1. [Как установить](./README.md#Как-установить)
2. [Как обновить](./README.md#Как-обновить)
3. [Команды](./README.md#Команды)
...
Спасибо за вдохновение и проект, который стал отправной точкой моего пути в программировании:

> Юрий Юшманов [VK](https://vk.com/id460908267) | [GitHub](https://github.com/lordralinc)

Спасибо за помощь в разработке и реализацию связующего сервера ICAD:

> [Евгений Лисицын](https://vk.com/id230192963)
