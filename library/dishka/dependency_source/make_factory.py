...
from library.dishka._adaptix.type_tools.basic_utils import (  # type: ignore[attr-defined]
    get_type_vars,
    is_bare_generic,
    strip_alias,
)
from library.dishka._adaptix.type_tools.fundamentals import (
    get_all_type_hints,
)
from library.dishka._adaptix.type_tools.generic_resolver import (
    GenericResolver,
    MembersStorage,
)
from library.dishka.entities.factory_type import FactoryType
from library.dishka.entities.key import (
    dependency_key_to_hint,
    hint_to_dependency_key,
    hints_to_dependency_keys,
)
from library.dishka.entities.provides_marker import ProvideMultiple
from library.dishka.entities.scope import BaseScope
from library.dishka.text_rendering import get_name
