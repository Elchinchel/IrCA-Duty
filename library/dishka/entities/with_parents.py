...
from library.dishka._adaptix.common import TypeHint
from library.dishka._adaptix.feature_requirement import HAS_PY_311
from library.dishka._adaptix.type_tools.basic_utils import is_parametrized
